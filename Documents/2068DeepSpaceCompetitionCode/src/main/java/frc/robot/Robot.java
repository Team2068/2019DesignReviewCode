...
public class Robot extends TimedRobot {
  ...
  //private Solenoid suction2 = new Solenoid(4); // cole said to change to port three, was originally port four
  ...
  private PneumaticsControl hatchIntake = new PneumaticsControl(suctionCups, airOutake, hatchPiston, mechanismController);
  ...
  private MechanismControl mechanismControl = new MechanismControl(cargoIntake, hatchIntake, lift, mechanismController);
 ...
 // private LiftPistonControl LiftPistonControl = new LiftPistonControl(liftPistonFL, liftPistonBL, liftPistonBR, chassisJoystick);
  private LiftPistonControl liftPistonControl = new LiftPistonControl(liftPistonFront, liftPistonBack, chassisJoystick);
  
  //private DeepSpaceLightControl lighting = new DeepSpaceLightControl(SerialPort.Port.kUSB, 9600);

  private int LEFT_COLOR_SENSOR_PORT = 6, RIGHT_COLOR_SENSOR_PORT = 7, LEFT_PROX_SENSOR_PORT = 3, RIGHT_PROX_SENSOR_PORT = 2;
  private int [] ports = {LEFT_COLOR_SENSOR_PORT, RIGHT_COLOR_SENSOR_PORT, LEFT_PROX_SENSOR_PORT, RIGHT_PROX_SENSOR_PORT};
