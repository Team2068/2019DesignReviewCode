...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    // chassisJoystick.getBumper(GenericHID.Hand.kRight))
    // {
    // if(frontPistonFlag)
    // {
    // liftPistonFront.set(DoubleSolenoid.Value.kReverse);
    ...
    // }
    // SmartDashboard.putString("Front Lift Piston",
    // liftPistonFront.get().toString());
    // SmartDashboard.putString("Back Lift Piston",
    // liftPistonBack.get().toString());
  }
  // frontRight.set(1);
