...
public class DriveTrain
{
  ...
  {
      if(controller.getXButtonPressed()) //previously A Button
      {
          frontLeft.setIdleMode(IdleMode.kCoast);
          frontRight.setIdleMode(IdleMode.kCoast);
          backLeft.setIdleMode(IdleMode.kCoast);
  ...
  public void autoDriveForward(double rightSpeed, double leftSpeed, double targetRevsLeft, double targetRevsRight)
  {
      resetEncoders();
  ...
  public void displayValues()
  {
      ...
      SmartDashboard.putNumber("Back Left Encoder", backLeft.getEncoder().getPosition());
      SmartDashboard.putNumber("Back Right Encoder", backRight.getEncoder().getPosition());
