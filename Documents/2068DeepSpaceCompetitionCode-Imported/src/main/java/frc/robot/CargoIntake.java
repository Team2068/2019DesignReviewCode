...
public class CargoIntake
{
    ...
    public void baseControl()
    {
        ...
        {
            drawbridgeMotor.set(controller.getY(GenericHID.Hand.kRight)/2);
        }
        ...
        {
            intakeMotor.set(controller.getTriggerAxis(GenericHID.Hand.kRight) * .60);
        }
        else if(controller.getTriggerAxis(GenericHID.Hand.kLeft) > .25)
        {
            intakeMotor.set(-controller.getTriggerAxis(GenericHID.Hand.kLeft) * .60);
        }
        else 
        {
            intakeMotor.set(0);
