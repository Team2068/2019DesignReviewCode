...
import frc.sensors.i2c.oled.font.Font;
...
public class Graphics {
	...
	public void centerText(int y, Font font, String text) {
		int rawLength = font.getColumns() * text.length() + text.length();
		int maxLength = ssd1306.getWidth();
		int difference = maxLength - rawLength;

		int offset = (difference < 0)? 0 : difference / 2;
		text(offset, y, font, text);
	}
