...
private short cSens = 0b11111111;
private short pSens = 0b11111000;

private short threshold = 16;

public I2CColorSensor(I2C.Port port) {
...
public void read() {
    ...
    red = (short)(buffy.getShort(0) & cSens);
    if(red < 0) { red += 0b10000000000000000; }
    
    green = (short)(buffy.getShort(2) & cSens);
    if(green < 0) { green += 0b10000000000000000; }
    
    blue = (short)(buffy.getShort(4) & cSens); 
    if(blue < 0) { blue += 0b10000000000000000; }
    
    prox = (short)(buffy.getShort(6) & pSens); 
...
public short getGreyscale() {
    read();
    return (short)((red + green + blue) / 3);
}

public void setColorSensitivity(int s) {
    cSens = (short)~s;
}

public void setProximitySensitivity(int s) {
    pSens = (short)~s;
}
